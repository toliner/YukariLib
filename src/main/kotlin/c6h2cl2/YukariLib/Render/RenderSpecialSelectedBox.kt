...
class RenderSpecialSelectedBox {

    val extraSpace = 0.002

    fun drawSelectionBox(thePlayer: EntityPlayer, mop: MovingObjectPosition, pTickTime: Float, selectedBox: SpecialSelectedBox) {
    ...
    fun drawOutlinedBoundingBox(selectedBox: SpecialSelectedBox) {
    ...
    fun addVerticalVertexs(selectedBox: SpecialSelectedBox, tessellator: Tessellator) {
    ...
    fun addTopBottomVertex(selectedBox: SpecialSelectedBox, side: Int, sideLength: Double, heightToAdd: Double, tessellator: Tessellator) {
    ...
    fun addMainVertex(selectedBox: SpecialSelectedBox, side: Int, heightToAdd: Double, tessellator: Tessellator) {
        if (!selectedBox.drawSide[side]) {
            if (!selectedBox.drawSide[4]) {
                //メインの線
                tessellator.addVertex(selectedBox.minX, selectedBox.minY + heightToAdd, selectedBox.minZ)
